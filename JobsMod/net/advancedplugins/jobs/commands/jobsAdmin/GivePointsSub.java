...
public class GivePointsSub extends JobSubCommand<CommandSender> {
   private final Core plugin;

   public GivePointsSub(Core var1) {
      super(var1, true);
      this.plugin = var1;
      this.inheritPermission();
      this.addFlats(new String[]{"give", "points"});
      this.addArgument(
   ...
   public void onExecute(CommandSender var1, String[] var2) {
      ...
      if (!var3.isPresent()) {
         ...
         this.plugin.getJobController().givePoints((User)var3.get(), var4);
