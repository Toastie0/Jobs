...
import su.nightexpress.moneyhunters.pro.api.event.PlayerJobLevelUpEvent;

public class MoneyHuntersProQuests extends ActionQuestExecutor {
   public MoneyHuntersProQuests(JavaPlugin var1) {
