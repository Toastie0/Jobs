...
public class PremiumJobsMenu extends PageableConfigMenu<Job> implements UserDependent {
   ...
   public PremiumJobsMenu(Core var1, Config var2, Player var3) {
   ...
   public MenuItem pageableItem(Job var1) {
      try {
         ...
         String var13 = Core.getInstance().getBoostersController().getMenuLore(this.player, var1);
   ...
   public ImmutablePair<Collection<Job>, Collection<Integer>> elementalValues() {
      return ImmutablePair.of(this.jobsResetHandler.getCurrentPremiumJobs(), MenuService.parseSlots(this, this.config, "jobs-slots"));
   }
