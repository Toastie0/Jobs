package net.toastie.jobs;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import net.toastie.jobs.commands.JobsAdminCommand;
import net.toastie.jobs.commands.JobsCommand;
...
import net.toastie.jobs.handlers.BlockBreakHandler;
import net.toastie.jobs.handlers.BlockPlaceHandler;
import net.toastie.jobs.handlers.CropHarvestHandler;
...
public class JobsFabricMod implements DedicatedServerModInitializer {
    ...
    public static JobsFabricMod getInstance() {
        return instance;
    }
